...
def main():
    ...
    for joystick in devices:
        ...
        if name == "G27 Racing Wheel":
            #check for handbrake
            secondaryId = None
            for joystick2 in devices:
                name2 = joystick2.name
                if name2 == "LLC Arduino Micro":
                    secondaryId = joystick2.device
            controlsList = getG27ControlMap(joystick.device, secondaryId)
