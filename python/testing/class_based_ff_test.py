...
def main():
    ...
    while True:
        ...
        # force = -1
        # if abs(finalState.channels[0] - ffTarget) < 50:
        #     force = 0
        #     ffTarget = random.randint(1000, 2000)
        ...
        #print(f"Merged: {finalState.channels} Target {ffTarget} Force {force}")
        nowTime = time.time()
        timeDiff = nowTime - startTime
        print(f"Merged: {finalState.channels} Updates {loopCount} Time {timeDiff}")
        #time.sleep(0.016)
